    ...
    <section id="sobre" className="relative py-28 sm:py-32">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <SectionHeading
          ...
          description="Sou Gabriel Pego Feitosa, Desenvolvedor de Software Júnior de Dois Vizinhos/PR. Gosto de transformar problemas reais em sistemas confiáveis, escaláveis e bem instrumentados."
        />
